...
int main() {
    // Test parameters
    const char *message = "with due respect I hereby state the completion of this key signatures and all if possible we are just complete here lorem ipsum  lorem                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               lorem                                                                                                                                               ";
